...
public class SocketServerConnection implements PersistentServerConnection {
    ...
    public SocketServerConnection(Socket socket, ClientController clientController) throws IOException{
    ...
    public void connect(UUID id){
        this.remote.sendCommand(new ServerCommand.RegisterCommand(id));
    }
